...
public partial class SettingsForm : Form
{
    ...
    private void InitializeUserControls()
    {
        ...
        controlRemovePartId.PartRemoved += (s, e) => { UpdateStatus("Part removed successfully - lists refreshed"); };
    ...
    private void ThemeComboBox_SelectedIndexChanged(object? sender, EventArgs e)
    {
        ...
        {
            Core_Themes.Core_AppThemes.AppTheme theme = Core_Themes.Core_AppThemes.GetTheme(themeName);
    ...
    private async Task SaveSettingsJson()
    {
        ...
        {
            string user = Model_AppVariables.User;
            string? themeName = SettingsForm_ComboBox_Theme.SelectedItem?.ToString();
