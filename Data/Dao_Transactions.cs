...
namespace MTM_Inventory_Application.Data
{
    internal class Dao_Transactions
    {
        ...
        public List<Model_Transactions> SearchTransactions(
            ...
            string sortColumn = "DateTime",   // Default sort column
        ...
        )
        {
            ...
            var validColumns = new HashSet<string> {
                "ID", "TransactionType", "Batch Number", "PartID", "FromLocation",
                "ToLocation", "Operation", "Quantity", "Notes", "User", "ItemType", "DateTime"
            };
            if (!validColumns.Contains(sortColumn))
            {
                sortColumn = "DateTime"; // fallback to safe default
            }
        ...
        private Model_Transactions MapTransaction(MySqlDataReader reader)
        {
            return new Model_Transactions
            {
                ...
                TransactionType = Enum.TryParse<TransactionType>(reader["TransactionType"].ToString(), out var type) ? type : TransactionType.IN,
                BatchNumber = reader["Batch Number"] == DBNull.Value ? null : reader["Batch Number"].ToString(),
                ...
                DateTime = reader["DateTime"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(reader["DateTime"])
            };
        }
    }
}