...
-- Remove inventory item with detailed status reporting (Already has status parameters)
DELIMITER $$
...
-- Fix batch numbers (consolidate and clean up) - Already has status parameters
DELIMITER $$
