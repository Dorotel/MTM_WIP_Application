...
REM Updated: For MAMP MySQL 5.7.24 compatibility
...
echo [INFO] Executing User Management Procedures ^(MySQL 5.7.24 Compatible^)...
if exist "01_User_Management_Procedures.sql" (
    ...
    if errorlevel 1 (
        ...
        echo [INFO] User Management Procedures completed successfully
...
echo [INFO] Executing System Role Procedures...
if exist "02_System_Role_Procedures.sql" (
    ...
    if errorlevel 1 (
        ...
        echo [INFO] System Role Procedures completed successfully
        set /a success_count+=1
    )
) else (
...
echo [INFO] Executing Master Data Procedures...
if exist "03_Master_Data_Procedures.sql" (
    ...
    if errorlevel 1 (
        ...
        echo [INFO] Master Data Procedures completed successfully
        set /a success_count+=1
    )
) else (
...
echo [INFO] Executing Inventory Management Procedures...
if exist "04_Inventory_Procedures.sql" (
    ...
    if errorlevel 1 (
        ...
        echo [INFO] Inventory Management Procedures completed successfully
        set /a success_count+=1
    )
) else (
...
if errorlevel 1 (
    ...
    echo [INFO] MySQL version check completed
)
