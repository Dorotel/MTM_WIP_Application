...
namespace MTM_Inventory_Application.Controls.SettingsForm
{
    public partial class EditLocationControl : UserControl
    {
        ...
        private async void LocationsComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"Error loading location details: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private async void SaveButton_Click(object sender, EventArgs e)
        {
            if (_currentLocation == null)
            {
                MessageBox.Show("Please select a location to edit.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            try
            {
                ...
                {
                    MessageBox.Show("Building is required.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                ...
                {
                    MessageBox.Show($"Location '{newLocation}' already exists.", "Duplicate Location", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    locationTextBox.Focus();
                    return;
                }
