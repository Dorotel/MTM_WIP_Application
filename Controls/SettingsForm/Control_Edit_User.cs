...
public partial class Control_Edit_User : UserControl
{
    ...
    public Control_Edit_User()
    {
        ...
        Control_Edit_User_CheckBox_VisualAccess.CheckedChanged += Control_Edit_User_CheckBox_VisualAccess_CheckedChanged;
        Control_Edit_User_CheckBox_ViewHidePasswords.CheckedChanged += Control_Edit_User_CheckBox_ViewHidePasswords_CheckedChanged;
        Control_Edit_User_ComboBox_Users.SelectedIndexChanged += Control_Edit_User_ComboBox_Users_SelectedIndexChanged;
    ...
    {
        Control_Edit_User_ComboBox_Users.Items.Clear();
        ...
        foreach (DataRow row in users.Rows)
        {
            ...
            {
                Control_Edit_User_ComboBox_Users.Items.Add(user);
            }
        }

        if (Control_Edit_User_ComboBox_Users.Items.Count > 0)
        {
            Control_Edit_User_ComboBox_Users.SelectedIndex = 0;
        }
    }
