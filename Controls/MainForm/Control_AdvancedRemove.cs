...
{summary}Are you sure?",
        ...
        private async Task Control_AdvancedRemove_HardReset()
        {
            ...
            try
            {
                Control_RemoveTab.MainFormInstance?.TabLoadingControlProgress?.ShowProgress();
                Control_RemoveTab.MainFormInstance?.TabLoadingControlProgress?.UpdateProgress(10,
            ...
            finally
            {
                ...
                if (Control_RemoveTab.MainFormInstance != null)
                {
                    ...
                    Control_RemoveTab.MainFormInstance?.TabLoadingControlProgress?.HideProgress();
                }
            }
        }
        ...
        public void SetProgressControls(ToolStripProgressBar progressBar, ToolStripStatusLabel statusLabel)
        {
            _progressHelper = Helper_StoredProcedureProgress.Create(progressBar, statusLabel, 
                this.FindForm() ?? throw new InvalidOperationException(
                    $"Control '{this.Name}' of type '{this.GetType().Name}' must be added to a Form before calling SetProgressControls. " +
                    "Ensure this control is added to a Form and visible in the control hierarchy.");
        }
