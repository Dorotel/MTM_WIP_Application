...
public partial class Control_AdvancedInventory : UserControl
{
    ...
    public Control_AdvancedInventory()
    {
        try
        {
            ...
            Helper_ComboBoxes.ApplyStandardComboBoxProperties(AdvancedInventory_Single_ComboBox_Part);
            Helper_ComboBoxes.ApplyStandardComboBoxProperties(AdvancedInventory_Single_ComboBox_Op);
            Helper_ComboBoxes.ApplyStandardComboBoxProperties(AdvancedInventory_Single_ComboBox_Loc);
            Helper_ComboBoxes.ApplyStandardComboBoxProperties(AdvancedInventory_MultiLoc_ComboBox_Part);
            ...
            AdvancedInventory_Single_ComboBox_Part.ForeColor = Color.Red;
            AdvancedInventory_Single_ComboBox_Op.ForeColor = Color.Red;
            AdvancedInventory_Single_ComboBox_Loc.ForeColor = Color.Red;
            AdvancedInventory_MultiLoc_ComboBox_Part.ForeColor = Color.Red;
            AdvancedInventory_MultiLoc_ComboBox_Op.ForeColor = Color.Red;
            AdvancedInventory_MultiLoc_ComboBox_Loc.ForeColor = Color.Red;
    ...
    private void WireUpEvents()
    {
        try
        {
            ...
            {
                InventoryTextBoxQty_TextChanged(AdvancedInventory_MultiLoc_TextBox_Qty, "[ Enter Valid Quantity ]");
                UpdateMultiSaveButtonState();
            ...
            AdvancedInventory_MultiLoc_TextBox_Qty.Click +=
                (s, e) => AdvancedInventory_MultiLoc_TextBox_Qty.SelectAll();
            AdvancedInventory_MultiLoc_TextBox_Qty.KeyDown += (sender, e) =>
            {
                MainFormControlHelper.AdjustQuantityByKey_Quantity(sender, e, "[ Enter Valid Quantity ]",
                    Color.Black, Color.Red);
            };
            ...
            AdvancedInventory_MultiLoc_RichTextBox_Notes.Leave += (s, e) =>
                AdvancedInventory_MultiLoc_RichTextBox_Notes.BackColor = SystemColors.Window;
            ...
            LoggingUtility.Log("Control_AdvancedInventory events wired up.");
        }
        catch (Exception ex)
        {
            LoggingUtility.LogApplicationError(ex);
