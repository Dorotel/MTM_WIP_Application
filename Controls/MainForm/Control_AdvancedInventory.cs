...
public partial class Control_AdvancedInventory : UserControl
{
    ...
    private async void AdvancedInventory_Single_Button_Reset_Click(object? sender, EventArgs e)
    {
        ...
        try
        {
            Debug.WriteLine("[DEBUG] AdvancedInventory Single Reset button clicked - start");

            // 3) Update status strip to show reset is in progress
            ...
            // 2) Unbind DataSource before DataTable reset
            ...
            // 8) Update Save/Send button state
            UpdateSingleSaveButtonState();


            Debug.WriteLine("[DEBUG] AdvancedInventory Single Reset button clicked - end");
        }
        catch (Exception ex)
        {
        ...
        {
            Debug.WriteLine("[DEBUG] AdvancedInventory Single Reset button re-enabled");
    ...
    private async void AdvancedInventory_MultiLoc_Button_Reset_Click(object? sender, EventArgs e)
    {
        ...
        try
        {
            Debug.WriteLine("[DEBUG] AdvancedInventory MultiLoc Reset button clicked - start");
            ...
            // 8) Update Save/AddLoc button state
            UpdateMultiSaveButtonState();


            Debug.WriteLine("[DEBUG] AdvancedInventory MultiLoc Reset button clicked - end");
        }
        catch (Exception ex)
        {
        ...
        {
            Debug.WriteLine("[DEBUG] AdvancedInventory MultiLoc Reset button re-enabled");
