# Dependency Chart: Control_AdvancedRemove.cs

**File Path**: `Controls/MainForm/Control_AdvancedRemove.cs`  
...
- 🗄️ `inv_inventory_Search_Advanced` - Purpose TBD - Status: TO_VERIFY
