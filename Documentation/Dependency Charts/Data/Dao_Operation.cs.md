# Dependency Chart: Dao_Operation.cs

**File Path**: `Data/Dao_Operation.cs`  
...
- 🗄️ `md_operation_numbers_Exists_ByOperation` - Purpose TBD - Status: TO_VERIFY
- 🗄️ `md_operation_numbers_Update_Operation` - Purpose TBD - Status: TO_VERIFY
- 🗄️ `md_operation_numbers_Add_Operation` - Purpose TBD - Status: TO_VERIFY
- 🗄️ `md_operation_numbers_Get_All` - Purpose TBD - Status: TO_VERIFY
- 🗄️ `md_operation_numbers_Delete_ByOperation` - Purpose TBD - Status: TO_VERIFY
